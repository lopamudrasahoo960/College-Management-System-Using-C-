 ...
 void edit_data()  
  ...
  {  
       ...
       {  
            ...
            cout<<"ttt-----------------------------------------n";  
            cout<<"ttt-----------------------------------------n";  
            cout<<"ntttEnter <1> to Add new student"  
                 <<"ntttEnter <2> to Display all student"  
                 <<"ntttEnter <3> to Remove student"  
                 <<"ntttEnter <4> to Edit student"  
                 <<"ntttEnter <5> to Search student"  
                 <<"ntttEnter <0> to Exitn";  
